...
jQuery(document).ready(function() {
  if (Backdrop.settings.suppot_pm.unload_warning) {
...
function unload_message() {
  return Backdrop.t("Any plan details you have entered for this week will be lost if you navigate away from this page without pressing the 'Save plan' button.");
}
